...
public class Driver {
    ...
    //henuz bir driver ile ilgili ayarlar yapmadigim icin baska class'lar bunu yanlislikla yapmasin diye
    //erisimi private yaptik (sadece bu class'in kullanimina acik)
